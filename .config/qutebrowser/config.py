...
c.url.default_page = "dorovich.github.io/c"
c.url.start_pages = ["dorovich.github.io/c"]
...
config.bind('<Ctrl-c>', 'spawn qtb-cleancookies;; spawn -d notify-send "Cookies have been cleaned"')
